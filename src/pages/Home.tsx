...
import {
  ...
  ChevronLeft, ChevronRight, CalendarDays, Users, Award,
  MapPin, FileText,
} from 'lucide-react';
...
function BeforeAfterTabSection() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tab row: bleeds to viewport edges so the last tab is never clipped */}
        <div className="mb-8 reveal reveal-delay-1 -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide px-4 sm:px-6 lg:px-8">
            ...
            {/* trailing spacer so last tab clears the right edge */}
